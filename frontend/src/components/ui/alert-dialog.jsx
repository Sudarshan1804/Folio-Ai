...
const AlertDialogContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsxs(AlertDialogPortal, { children: [/*#__PURE__*/
    _jsx(AlertDialogOverlay, {}), /*#__PURE__*/
...
const AlertDialogAction = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx(AlertDialogPrimitive.Action, { ref: ref, className: cn(buttonVariants(), className), ...props })
);
