...
const NavigationMenu = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(NavigationMenuPrimitive.Root, {
    ref: ref,
...
const NavigationMenuList = /*#__PURE__*/React.forwardRef(
  ...
  _jsx(NavigationMenuPrimitive.List, {
    ref: ref,
...
const NavigationMenuTrigger = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, children, ...props }, ref) => /*#__PURE__*/
  _jsxs(NavigationMenuPrimitive.Trigger, {
    ref: ref,
...
const NavigationMenuContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx(NavigationMenuPrimitive.Content, {
    ref: ref,
    className: cn(
...
const NavigationMenuViewport = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx("div", { className: cn("absolute left-0 top-full flex justify-center"), children: /*#__PURE__*/
    _jsx(NavigationMenuPrimitive.Viewport, {
      className: cn(
...
const NavigationMenuIndicator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx(NavigationMenuPrimitive.Indicator, {
    ref: ref,
    className: cn(
    ...
    _jsx("div", { className: "relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-border shadow-md" }) }
  )
);
