...
import { signUpFn } from "@/server-actions/auth";
      ...
      _jsx("div", { className: "relative flex-1 flex flex-col items-center justify-center p-6 mt-20", children: /*#__PURE__*/
        _jsxs(motion.div, {
          ...
          _jsxs("div", { className: "flex flex-col items-center text-center mb-8", children: [/*#__PURE__*/
            ...
            _jsx("h1", { className: "text-2xl font-bold tracking-tight mb-2", children: "Create an account" }), /*#__PURE__*/
            _jsx("p", { className: "text-sm text-muted-foreground", children: "Turn your resume into a portfolio in seconds" }
          ...
          _jsxs("form", { className: "space-y-4", onSubmit: handleSubmit, children: [
            ...
            _jsxs("div", { className: "space-y-2", children: [/*#__PURE__*/
              _jsx("label", { htmlFor: "name", className: "text-sm font-medium text-foreground/80", children: "Full Name" }
          ...
          _jsxs("div", { className: "mt-6 text-center text-sm text-muted-foreground", children: ["Already have an account?",
            " ", /*#__PURE__*/
            _jsx(Link, { to: "/signin", className: "text-foreground font-medium hover:text-primary transition-colors", children: "Sign in" }
