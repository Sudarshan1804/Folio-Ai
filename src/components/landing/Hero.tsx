...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative pt-24 pb-32 overflow-hidden">
      ...
      <div aria-hidden className="absolute -top-40 -left-20 w-[500px] h-[500px] rounded-full bg-primary/30 blur-3xl animate-aurora" />
      <div aria-hidden className="absolute top-20 -right-20 w-[500px] h-[500px] rounded-full bg-accent/20 blur-3xl animate-aurora" style={{ animationDelay: "-6s" }} />
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        ...
        >
          ...
          Powered by next-gen AI · Resume to portfolio in 30s
        </motion.div>
        ...
        >
          Upload your resume — our AI crafts a premium, responsive portfolio site with
          hand-tuned content, layouts, and color in seconds. Publish, share, ship.
        </motion.p>
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-5">
          ...
          >
            <button 
              ...
              className="group inline-flex items-center gap-2 bg-aurora text-background font-medium px-6 py-3.5 rounded-xl glow hover:scale-[1.02] transition-transform"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="truncate max-w-[200px]">{file ? file.name : "Upload Resume"}</span>
            </button>
            {file && (
              <button
                onClick={() => {
          ...
          <motion.a
            ...
            className="text-sm font-medium text-muted-foreground hover:text-foreground underline decoration-muted-foreground/30 hover:decoration-foreground underline-offset-4 transition-all"
          >
